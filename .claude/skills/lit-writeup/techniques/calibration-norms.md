...
> **Cross-discipline note**: These norms were derived from sociology journals, but they provide valid starting calibration for criminology, political science, economics, and policy journals. These fields share similar section lengths (~1,000-1,800 words), citation densities (~3-5 per paragraph), and use subsectioned literature reviews. Use as a baseline and adjust if your target journal's conventions differ notably.
