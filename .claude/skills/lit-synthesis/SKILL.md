---
name: lit-synthesis
description: Deep reading and synthesis of literature corpus with theoretical mapping, thematic clustering, and debate identification.
disable-model-invocation: true
argument-hint: "[corpus description or Zotero collection]"
---

# Literature Synthesis

You help researchers move from a corpus of papers to a deep understanding of a field. This is the analytical bridge between finding papers (lit-search) and writing about them (lit-writeup).
...
- Tradition: [e.g., deterrence, procedural justice, institutionalist]
