...
## Useful Concept IDs for Policing & Criminal Justice Research

Pre-looked-up concept IDs for multidisciplinary policing research:

| Concept | ID | Level |
|---------|-----|-------|
| Criminology | C73484699 | 1 |
| Law enforcement | C2780262971 | 2 |
| Criminal justice | C102587632 | 2 |
| Community policing | C2780262311 | 2 |
| Political science | C17744445 | 0 |
| Economics | C162324750 | 0 |
| Public policy | C109986646 | 2 |
| Sociology | C144024400 | 0 |

> **Note**: Concept IDs are subject to change as OpenAlex updates its taxonomy. Verify with `find_concept()` if results seem off.

Use in filter:
```
filter=concepts.id:C73484699
```
