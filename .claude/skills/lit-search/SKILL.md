---
name: lit-search
description: Systematic literature search using OpenAlex API with screening, snowballing, and annotation for policing and criminal justice research.
...
- **Wrong field**: Paper clearly from unrelated discipline (e.g., biomedical paper when searching criminal justice)
